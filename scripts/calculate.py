...
def calculate():
    ...
    try:
        ...
        available_datasets = dataset_helper.get_calculation_datasets()
...
if __name__ == '__main__':
    ...
    try:
        ...
        dataset_helper = DatasetHelper(logger, calculation_input_folder_path, calculation_output_folder_path)
